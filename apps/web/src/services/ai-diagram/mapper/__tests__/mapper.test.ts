...
describe('Diagram Mapper (Phase 3)', () => {
  ...
  test('Node immutability and ID preservation', () => {
    const graph = getEmptyGraph();
    graph.nodes.push({ id: 'n1', type: 'process', label: 'Processing', x: 10, y: 20, width: 100, height: 50 });
  ...
  test('Semantic metadata and label behavior', () => {
    const graph = getEmptyGraph();
    graph.nodes.push({ id: 'db1', type: 'database', label: 'User Data', x: 0, y: 0, width: 100, height: 100 });
  ...
  test('Unknown node fallback', () => {
    ...
    graph.nodes.push({ id: 'u1', type: 'unknown_magic_type', x: 0, y: 0, width: 10, height: 10 });
  ...
  test('Boundary connections and relationship preservation', () => {
    ...
    graph.nodes.push({ id: 'n1', type: 'process', label: '', x: 100, y: 100, width: 100, height: 50 });
    graph.nodes.push({ id: 'n2', type: 'process', label: '', x: 100, y: 300, width: 100, height: 50 });
  ...
  test('Horizontal boundary connection', () => {
    ...
    graph.nodes.push({ id: 'n2', type: 'process', label: '', x: 400, y: 100, width: 50, height: 100 });
    graph.edges.push({ id: 'e1', source: 'n1', target: 'n2' });
  ...
  test('Deterministic output', () => {
    ...
    graph.nodes.push({ id: 'n2', type: 'process', label: '', x: 100, y: 300, width: 100, height: 50 });
    graph.nodes.push({ id: 'n1', type: 'process', label: '', x: 100, y: 100, width: 100, height: 50 });
    graph.edges.push({ id: 'e2', source: 'n2', target: 'n1' });
    graph.edges.push({ id: 'e1', source: 'n1', target: 'n2' });
